...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"insert into tblappointment(AptNumber,Name,Email,PhoneNumber, Beautician,AptDate,AptTime,Services) value('$aptnumber','$name','$email','$phone', '$beautician','$adate','$atime','$services')");
	if ($query) 
	{
...
<body>
	...
	<section class="hero-wrap">
		<div class="home-slider owl-carousel js-fullheight">
			<div class="slider-item js-fullheight" style="background-image:url(images/bbg_1.png);">
				<div class="overlay"></div>
				<div class="container">
					<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
						<div class="col-md-12 ftco-animate">
							<div class="text w-100 mt-5 text-center">
								<span class="subheading">Blush Spa & Aesthetic</span>
								<h2 style="color: #ffffff; font-size: 70px;">Serving Since 2018</h2>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="slider-item js-fullheight" style="background-image:url(images/bbg_2.png);">
				<div class="overlay"></div>
				<div class="container">
					<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
						<div class="col-md-12 ftco-animate">
							<div class="text w-100 mt-5 text-center">
								<span class="subheading">Best Salon in Pagadian City </h2></span>
	...
	<section class="ftco-section ftco-wrap-about ftco-no-pb ftco-no-pt">
		<div class="container">
			<div class="row no-gutters">
				...
				<div class="col-sm-8 wrap-about py-5 ftco-animate img" style="background-image: url(images/ssstylist-3.jpg);">
	...
	<section class="ftco-section ftco-intro" style="background-image: url(images/ssaloncover2.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
		...
		<div class="container">
			<div class="row d-flex">
				<div class="col-md-6 d-flex">
					<div class="img img-2 w-100 mr-md-2" style="background-image: url(images/sservices-1.jpg);">
	...
	<section class="ftco-section bg-light">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/ssalon.jpg');">
						</a>
					</div>
				</div>
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/wwork-7.jpg');">
						</a>
					</div>
				</div>
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/ssalon3.jpg');">
						</a>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/ssalon4.jpg');">
						</a>
					</div>
				</div>
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/ssalon7.jpg');">
						</a>
					</div>
				</div>
				<div class="col-md-4 ftco-animate">
					<div class="blog-entry">
						<a href="#" class="block-20" style="background-image: url('images/ssalon6.jpg');">
						</a>
					</div>
				</div>
			</div>
...
<script>
	...
	function showUser(str) {
		if (str == "") {
			...
			xmlhttp.open("GET","getbeautician.php?q="+str,true);
			xmlhttp.send();
		} 
	}
	...
	function myFunction() {
		...
		document.getElementById("beautician").innerHTML = "You selected: " + services;

		$('#beautician').append($('<option>', { 
			value: services,
			text : services 
		}));
