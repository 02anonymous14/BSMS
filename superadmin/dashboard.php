...
<div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-primary">
        <?php
        // Todays Sale
        $query6 = mysqli_query($con, "SELECT SUM(tblservices.Cost) AS todays_sale 
                                    FROM tblinvoice 
        ...
        <a href="#today-sales" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
</div>
<!-- ./col -->
...
<div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-primary">
        <?php
        // Yesterday's sale
        $query7 = mysqli_query($con, "SELECT SUM(tblservices.Cost) AS yesterdays_sale 
                                    FROM tblinvoice 
                                    JOIN tblservices ON tblservices.ID = tblinvoice.ServiceId 
        ...
        <a href="#yesterday-sales" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
</div>
<!-- ./col -->
...
<div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-primary">
        ...
        $query8 = mysqli_query($con, "SELECT SUM(tblservices.Cost) AS seven_days_sale 
                                    FROM tblinvoice 
                                    JOIN tblservices ON tblservices.ID = tblinvoice.ServiceId 
                                    WHERE DATE(PostingDate) >= (CURDATE() - INTERVAL 7 DAY);");
        ...
        <a href="#seven-days-sales" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
</div>
<!-- ./col -->
...
<div class="col-lg-3 col-6">
    ...
    <div class="small-box bg-primary">
        <?php
        // Total Sale
        $query9 = mysqli_query($con, "SELECT SUM(tblservices.Cost) AS total_sales 
                                    FROM tblinvoice 
                                    JOIN tblservices ON tblservices.ID = tblinvoice.ServiceId;");
        ...
        <a href="#total-sales" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
</div>
<!-- ./col -->
