               ...
               <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    $getbilingid=mysqli_query($con,"SELECT DISTINCT `tblappointment`.Name,`tblinvoice_from_onlineappointment`.BillingId,`tblinvoice_from_onlineappointment`.PostingDate FROM  `tblappointment`   
                    JOIN `tblinvoice_from_onlineappointment` ON `tblappointment`.`Appointment_ID`=`tblinvoice_from_onlineappointment`.`Appointment_ID`  ORDER BY `tblinvoice_from_onlineappointment`.`Appointment_ID` DESC");
