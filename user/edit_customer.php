...
if(isset($_POST['submit']))
{
  ...
  $cid=$_SESSION['edid'];
  $query=mysqli_query($con, "update  tblcustomers set Name='$name',Email='$email',MobileNumber='$mobilenum',Gender='$gender',Details='$details' where Customers_ID='$cid' ");
  if ($query) {
...
<form method="post">
  ...
  {
    $_SESSION['edid']=$row['Customers_ID'];
    ?> 
    <div class="card-body">
