  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="#">
        ...
        <?php
        $ret1=mysqli_query($con,"select Appointment_ID,Name from  tblappointment where Status=''");
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <?php 
        $ret=mysqli_query($con,"select Appointment_ID,Name from  tblappointment where Status='' ORDER BY Appointment_ID DESC LIMIT 3");
        $num2=mysqli_num_rows($ret);
        if($num2>0){
          while($result=mysqli_fetch_array($ret))
          {
            ?>
            <a href="view-appointment.php?viewid=<?php echo $result['Appointment_ID'];?>" class="dropdown-item">
