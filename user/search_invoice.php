...
if(isset($_POST[('delete')])){
  ...
  if ($query) {
    ...
    echo "<script>window.location.href = 'search_invoice.php'</script>"; 
  } else {
            ...
            <div class="modal-dialog modal-lg ">
              <div class="modal-content">
                ...
                <div class="modal-body" id="info_update">
                  <?php @include("view_all_invoice.php");?>
                </div>
              ...
              <h5 align="center" style="color: blue;" class="mb-3">Result against "<?php echo $sdata;?>" keyword </h4> 
                <table class="table table-bordered"> 
                  ...
                  <tbody>
                    ...
                    $ret=mysqli_query($con,"SELECT * FROM  searchforinvoice where `Name` like '%$sdata%' ||  BillingId like '%$sdata%'");
                    ...
                    if($num>0){
                      ...
                      while ($row=mysqli_fetch_array($ret)) {
                        ...
                        <tr> 
                          ...
                          <div class="row"> 
                          <a href="#"  class="<?php if($row['invoicefrom'] == 'ONLINE APPOINTMENT'){echo "edit_data1";}else{echo "edit_data";} ?>" id="<?php echo  $row['BillingId']; ?>" title="click to view">View</a>
