...
if(isset($_POST['save2'])){
  ...
  $getapp=mysqli_query($con,"SELECT `Services` FROM `tblappointment` where Appointment_ID='$cid'");
  ...
  $resServiceID = $getserviceID['Services_ID'];
    ...
    if($_POST['status'] == '2'){
      ...
      $query=mysqli_query($con, "update tblappointment set Remark='$remark',Status='$status',Beautician='$beautician' where Appointment_ID='$cid'");
      $query1=mysqli_query($con,"INSERT INTO tblinvoice_from_onlineappointment(Services_ID,BillingId,invoicefrom,Appointment_ID) VALUES('$resServiceID','$invoiceid','ONLINE APPOINTMENT','$cid');");
