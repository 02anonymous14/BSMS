...
if (strlen($_SESSION['sid']==0)) {
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblbeauticians(Name, Phone, Email) value('$bname','$bphone','$bemail')");
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="Expertise" name="bexpertise" >
                        ...
                        <?php 
                          $allservices = mysqli_query($con,"SELECT Services_ID,ServiceName FROM tblservices");
                          while ($services = mysqli_fetch_array($allservices)):;
                        ?>
                          
                          <option value="<?php echo $services["ServiceName"]; ?>">
                            <?php echo $services["ServiceName"];?>
                          </option> 
